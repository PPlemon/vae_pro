...
def main():
    ...
    predictorname = '/data/tp/data/model/predictor_vae_model_w2v_30_new_250000_42(qed).h5'
    ...
    TensorBoardname = '/data/tp/data/TensorBoard/predictor_vae_model_w2v_30_new_250000_42(qed)'
