...
def main():
    ...
    predictorname = '/data/tp/data/model/predictor_vae_model_glove_35_new_w2_250000_42(5qed-sas)(std=1).h5'
    ...
    TensorBoardname = '/data/tp/data/TensorBoard/predictor_vae_model_glove_35_new_w2_250000_42(5qed-sas)(std=1)'
