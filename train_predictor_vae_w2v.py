...
def main():
    ...
    predictorname = '/data/tp/data/model/predictor_vae_model_w2v_35_new_w2_n1_250000_0(5qed-sas)(std=1)(tanh).h5'
    ...
    TensorBoardname = '/data/tp/data/TensorBoard/predictor_vae_model_w2v_35_new_w2_n1_250000_0(5qed-sas)(std=1)(tanh)'
