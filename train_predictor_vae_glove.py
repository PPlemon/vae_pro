...
def main():
    filename = '/data/tp/data/per_all_glove_30_250000.h5'
    ...
    predictorname = '/data/tp/data/model/predictor_vae_model_glove_30_250000_42(5qed-sas).h5'
    ...
    TensorBoardname = '/data/tp/data/TensorBoard/predictor_vae_model_glove_30_250000_42(5qed-sas)'
